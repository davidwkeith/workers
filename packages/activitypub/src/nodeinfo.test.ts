...
import { buildNodeInfo21, buildNodeInfoDiscovery } from "./nodeinfo";

describe("NodeInfo", () => {
  it("the discovery doc points at the 2.1 document", () => {
    ...
    expect(links[0]?.href).toBe("https://example.com/nodeinfo/2.1");
  });
