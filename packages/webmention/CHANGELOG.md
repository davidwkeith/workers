...
- 461ef4e: Recognize IndieWeb Vouch (indieweb.org/Vouch). A receiver may include an
...
- 876b556: Fix Vouch verification (indieweb.org/Vouch), shipped in the prior `minor` release with two
