...
original method and body. `307`/`308` still preserve the method and body, as
documented, and the redirect docs now note that a streamed (`ReadableStream`)
body can't be re-sent across hops.
